                ...
                <div className="header-top">
                    <div className="container">
                        ...
                        <div className="header-right">
                            ...
                            <div className="dropdown">
                                <a href="#language"><img src="https://pngimg.com/d/england_PNG7.png" alt="ENG Flag" width="14"
                                        height="8" className="dropdown-image" /> ENG</a>
                                <div className="dropdown-box">
                                    <a href="#ENG">
                                        <img src="https://pngimg.com/d/england_PNG7.png" alt="ENG Flag" width="14" height="8"

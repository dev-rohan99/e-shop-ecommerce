                                ...
                                <div className="product product-single row">
                                    ...
                                    <div className="col-md-6 mb-4 mb-md-6">
                                        <div className="product-details" data-sticky-options="{'minWidth': 767}">
                                            ...
                                            <div className="product-price"><ins className="new-price">$40.00</ins></div>
                                                ...
                                                <div className="product product-wrap text-center">
                                                    <figure className="product-media">
                                                        <img src="assets/images/products/default/bought-2.jpg" alt="Product"
                                                            width="138" height="138" />
                                                        <div className="product-checkbox">
                                                            <input type="checkbox" className="custom-checkbox" id="product_check2"
                                                                name="product_check2"/>
                                                            <label></label>
                                                        </div>
                                                    </figure>
                                                ...
                                                <div className="product product-wrap text-center">
                                                    <figure className="product-media">
                                                        <img src="assets/images/products/default/bought-3.jpg" alt="Product"
                                                            width="138" height="138" />
                                                        <div className="product-checkbox">
                                                            <input type="checkbox" className="custom-checkbox" id="product_check3"
                                                                name="product_check3"/>
                                                            <label></label>
                                                        </div>
                                                    </figure>
